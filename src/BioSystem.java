...
class BioSystem {
    ...
    private double deterioration_rate = 0.023;
    ...
    private double getDeterioration_rate(){
        return deterioration_rate;
    }

    private double getBiofilm_threshold(){
        return biofilm_threshold;
    }
            ...
            for(int bac_index = original_popsizes[mh_index] - 1; bac_index >= 0; bac_index--) {
                ...
                if(death_allocations[mh_index][bac_index] != 0) {
                    ...
                    if(system_size > 1) {
                        ...
                        n_migrations += migration_allocations[mh_index][bac_index];
                    }
